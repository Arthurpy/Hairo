    ...
    <form class="mx-auto flex w-full max-w-lg flex-col rounded-xl border border-border bg-backgroundSecondary p-4 sm:pl-20 pr-20 pt-8 pb-8 bg-white"
        ...
        <div class="form-group">
            <div class="form-field">
                ...
                <input v-model="email" placeholder="Type here" type="email" class="input max-w-full bg-white" />
            ...
            <div class="form-field">
                ...
                <div class="form-control">
                    <input v-model="password" placeholder="Type here" type="password" class="input max-w-full bg-white" />
                </div>
            </div>
            <div class="form-field">
